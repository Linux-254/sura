...
import { ArrowUpRight, CheckCircle2, Eye, KeyRound, LockKeyhole, Mail, ShieldCheck, Sparkles } from "lucide-react";
...
export default function AuthPage() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    setMessage(null);
    if (mode === "sign-up") {
      const result = await signUp.mutateAsync({ email, password, redirectTo });
      setMessage(result.status === "verification_and_link_required"
        ? "Check your inbox to verify this email. Then sign in once and confirm the link to your existing SURA space."
        : "Check your inbox to verify this email, then return here to sign in.");
      return;
    }
    if (mode === "recovery") {

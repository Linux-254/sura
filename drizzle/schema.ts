...
export const companies = mysqlTable(
  "companies",
  {
    ...
    deliverySameCityKes: int("deliverySameCityKes").default(450).notNull(),
    deliveryNationalKes: int("deliveryNationalKes").default(950).notNull(),
    deliveryProviderLabel: varchar("deliveryProviderLabel", { length: 100 }).default("Company delivery estimate").notNull(),
